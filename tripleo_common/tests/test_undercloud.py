...
from tripleo_common import undercloud
...
class TestUndercloud(BaseTestCase):
    @mock.patch('tripleo_common.undercloud._configure_logging')
    @mock.patch('tripleo_common.undercloud._check_hostname')
    @mock.patch('tripleo_common.undercloud._run_command')
    @mock.patch('tripleo_common.undercloud._configure_ssh_keys')
    @mock.patch('tripleo_common.undercloud._run_orc')
    @mock.patch('tripleo_common.undercloud._run_instack')
    @mock.patch('tripleo_common.undercloud._generate_environment')
    @mock.patch('tripleo_common.undercloud._load_config')
...
class TestCheckHostname(BaseTestCase):
    ...
    def test_correct(self, mock_run_command):
        ...
        with mock.patch('tripleo_common.undercloud.open',
...
class TestGenerateEnvironment(BaseTestCase):
    def setUp(self):
        ...
        self.useFixture(mockpatch.Patch(
            'tripleo_common.undercloud._write_password_file'))
        self.useFixture(mockpatch.Patch(
            'tripleo_common.undercloud._load_config'))
...
class TestRunTools(BaseTestCase):
    @mock.patch('tripleo_common.undercloud._run_live_command')
...
@mock.patch('tripleo_common.undercloud._run_command')
class TestConfigureSshKeys(BaseTestCase):
    ...
    @mock.patch('tripleo_common.undercloud._extract_from_stackrc')
    @mock.patch('tripleo_common.undercloud._ensure_user_identity')
